...
With a new release, whether it's a major or a minor release, comes a new version number. Make sure to update the following files:
...
- [ ] ~/G-Series_in_R_roadmap.Rmd (**Complete R Version Roadmap/Changelog**)
