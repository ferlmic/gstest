# Contributor Covenant Code of Conduct for the `gstest` project

([Français](#code-de-conduite-pour-le-projet-gstest))

Contributors to repositories hosted in `gstest` are expected to follow the Contributor Covenant Code of Conduct, and those working within Government are also expected to follow the [Values and Ethics Code for the Public Sector](https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=25049).
...
# Code de conduite pour le projet `gstest`
<!--markdownlint-enable MD025-->

([English](#contributor-covenant-code-of-conduct-for-the-gstest-project))

Les contributeurs aux dépôts hébergés dans `gstest` sont tenus de respecter le Code de conduite du Pacte des contributeurs, et ceux qui travaillent au sein du gouvernement sont également tenus de respecter le [Code de valeurs et d'éthique du secteur public](https://www.tbs-sct.canada.ca/pol/doc-fra.aspx?id=25049).
